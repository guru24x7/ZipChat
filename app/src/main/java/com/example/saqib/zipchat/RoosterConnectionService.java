package com.example.saqib.zipchat;
...
public class RoosterConnectionService extends Service {
    ...
    public static final String UI_AUTHENTICATED = "com.example.saqib.zipchat.uiauthenticated";
    public static final String SEND_MESSAGE = "com.example.saqib.zipchat.sendmessage";
    public static final String BUNDLE_MESSAGE_BODY = "b_body";
    public static final String BUNDLE_TO = "b_to";

    public static final String NEW_MESSAGE = "com.example.saqib.zipchat.newmessage";
